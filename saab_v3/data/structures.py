...
class EncodedTag(BaseModel):
    """Encoded tag with both indices (for embeddings) and original symbols (for SAAB bias)."""
    ...
    original_tag: StructureTag  # Original symbolic tag for SAAB bias computation
