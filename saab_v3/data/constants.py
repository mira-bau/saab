...
SEP_TOKEN = "[SEP]"
NONE_TOKEN = "[NONE]"
FIELD_START_TOKEN = "[FIELD_START]"
MASK_FIELD_TOKEN = "[MASK_FIELD]"

# Standard special token sets
VALUE_SPECIAL_TOKENS = [PAD_TOKEN, UNK_TOKEN, MASK_TOKEN, CLS_TOKEN, SEP_TOKEN, FIELD_START_TOKEN]
TAG_SPECIAL_TOKENS = [PAD_TOKEN, NONE_TOKEN, UNK_TOKEN, MASK_FIELD_TOKEN]
