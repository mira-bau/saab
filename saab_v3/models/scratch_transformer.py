"""Scratch Transformer: Strong baseline with full structural embeddings."""
...
class ScratchTransformer(BaseTransformer):
    """Scratch Transformer: Strong baseline with full structural embeddings.

    Uses all structural embeddings (token, positional, type, field, entity, time)
    but standard attention mechanism. Structure is encoded only in embeddings;
    the model must learn to use structure implicitly.
    """
    ...
    def __init__(
        ...
        """Initialize Scratch Transformer.
    ...
    def forward(
        ...
        """Forward pass through Scratch Transformer.
